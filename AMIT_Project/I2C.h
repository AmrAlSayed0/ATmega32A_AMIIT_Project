...
typedef enum _I2C_TRANS_MODE_t
{
    ...
    I2C_MASTER_RECIVER = ( uint8_t ) 2 ,
    I2C_SLAVE_TRANSMITTER = ( uint8_t ) 3 ,
    I2C_SLAVE_RECIVER = ( uint8_t ) 4
} I2C_TRANS_MODE_t;
typedef enum _I2C_STATUS_t
{
    ...
    I2C_STATUS_M_DATA_TRANS_ACK_REC = ( uint8_t ) 0x30 ,
    I2C_STATUS_M_DATA_TRANS_NACK_REC = ( uint8_t ) 0x38 ,
    ...
    I2C_STATUS_S_GEN_CALL_REC_ACK_TRANS_1 = ( uint8_t ) 0x70 ,
