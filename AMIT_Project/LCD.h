...
#define INS_FUNCTION_SET_BASE           0x20
#define INS_FUNCTION_SET_4_BIT          0x00 // 4-bit display by default
#define INS_FUNCTION_SET_8_BIT          0x10 // 4-bit display by default
#define INS_FUNCTION_SET_1_LINES        0x00 // 1 line by default
#define INS_FUNCTION_SET_2_LINES        0x08 // 1 line by default
#define INS_FUNCTION_SET_5_7_DOTS       0x00 // 5x7 dots by default
#define INS_FUNCTION_SET_5_10_DOTS      0x04 // 5x7 dots by default
#define INS_ENTRY_MODE_SET_BASE         0x04
#define INS_ENTRY_MODE_SET_DECREMENT    0x00 // Decrement cursor position by default
#define INS_ENTRY_MODE_SET_INCREMENT    0x02 // Decrement cursor position by default
#define INS_ENTRY_MODE_SET_NO_SHIFT     0x00 // No display shift by default
#define INS_ENTRY_MODE_SET_SHIFT        0x01 // No display shift by default
...
#define CGRAM_ADDR( addr )              ( ( ( uint8_t ) ( 1 << 6 ) ) | addr )
#define DDRAM_ADDR( addr )              ( ( ( uint8_t ) ( 1 << 7 ) ) | addr )
/*
