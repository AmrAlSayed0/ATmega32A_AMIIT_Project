...
TIMER_STD_ERR_t TIMER_setMode ( TIMER_t timer , TIMER_MODE_t modeToSet )
{
    ...
    switch ( timer )
    {
        case TIMER_0:
            switch ( modeToSet )
            {
                case TIMER_MODE_NORMAL :
                    REPLACE_BITS ( TCCR0 , ( 0 << WGM01 ) | ( 0 << WGM00 ) , BIT_MASK ( WGM01 ) | BIT_MASK ( WGM00 ) );
                    break;
                case TIMER_MODE_CTC_OCR_TOP:
                    REPLACE_BITS ( TCCR0 , ( 1 << WGM01 ) | ( 0 << WGM00 ) , BIT_MASK ( WGM01 ) | BIT_MASK ( WGM00 ) );
                    break;
                case TIMER_MODE_FAST_PWM_MAX_TOP:
                    REPLACE_BITS ( TCCR0 , ( 1 << WGM01 ) | ( 1 << WGM00 ) , BIT_MASK ( WGM01 ) | BIT_MASK ( WGM00 ) );
                    break;
                case TIMER_MODE_PHASE_PWM_MAX_TOP:
                    REPLACE_BITS ( TCCR0 , ( 0 << WGM01 ) | ( 1 << WGM00 ) , BIT_MASK ( WGM01 ) | BIT_MASK ( WGM00 ) );
                    break;
        ...
        case TIMER_1:
            ...
            {
                case TIMER_MODE_NORMAL :
                    REPLACE_BITS ( TCCR1A , ( 0 << WGM11 ) | ( 0 << WGM10 ) , BIT_MASK ( WGM11 ) | BIT_MASK ( WGM10 ) );
                    REPLACE_BITS ( TCCR1B , ( 0 << WGM13 ) | ( 0 << WGM12 ) , BIT_MASK ( WGM13 ) | BIT_MASK ( WGM12 ) );
                    break;
                case TIMER_MODE_CTC_OCR_TOP:
                    REPLACE_BITS ( TCCR1A , ( 0 << WGM11 ) | ( 0 << WGM10 ) , BIT_MASK ( WGM11 ) | BIT_MASK ( WGM10 ) );
                    REPLACE_BITS ( TCCR1B , ( 0 << WGM13 ) | ( 1 << WGM12 ) , BIT_MASK ( WGM13 ) | BIT_MASK ( WGM12 ) );
                    break;
                case TIMER_MODE_CTC_ICR_TOP:
                    REPLACE_BITS ( TCCR1A , ( 0 << WGM11 ) | ( 0 << WGM10 ) , BIT_MASK ( WGM11 ) | BIT_MASK ( WGM10 ) );
                    REPLACE_BITS ( TCCR1B , ( 1 << WGM13 ) | ( 0 << WGM12 ) , BIT_MASK ( WGM13 ) | BIT_MASK ( WGM12 ) );
                    break;
                case TIMER_MODE_FAST_PWM_0xFF_TOP:
                    REPLACE_BITS ( TCCR1A , ( 0 << WGM11 ) | ( 1 << WGM10 ) , BIT_MASK ( WGM11 ) | BIT_MASK ( WGM10 ) );
                    REPLACE_BITS ( TCCR1B , ( 0 << WGM13 ) | ( 1 << WGM12 ) , BIT_MASK ( WGM13 ) | BIT_MASK ( WGM12 ) );
                    break;
                case TIMER_MODE_FAST_PWM_0x1FF_TOP:
                    REPLACE_BITS ( TCCR1A , ( 1 << WGM11 ) | ( 0 << WGM10 ) , BIT_MASK ( WGM11 ) | BIT_MASK ( WGM10 ) );
                    REPLACE_BITS ( TCCR1B , ( 0 << WGM13 ) | ( 1 << WGM12 ) , BIT_MASK ( WGM13 ) | BIT_MASK ( WGM12 ) );
                    break;
                case TIMER_MODE_FAST_PWM_0x3FF_TOP:
                    REPLACE_BITS ( TCCR1A , ( 1 << WGM11 ) | ( 1 << WGM10 ) , BIT_MASK ( WGM11 ) | BIT_MASK ( WGM10 ) );
                    REPLACE_BITS ( TCCR1B , ( 0 << WGM13 ) | ( 1 << WGM12 ) , BIT_MASK ( WGM13 ) | BIT_MASK ( WGM12 ) );
                    break;
                case TIMER_MODE_FAST_PWM_OCR_TOP:
                    REPLACE_BITS ( TCCR1A , ( 1 << WGM11 ) | ( 1 << WGM10 ) , BIT_MASK ( WGM11 ) | BIT_MASK ( WGM10 ) );
                    REPLACE_BITS ( TCCR1B , ( 1 << WGM13 ) | ( 1 << WGM12 ) , BIT_MASK ( WGM13 ) | BIT_MASK ( WGM12 ) );
                    break;
                case TIMER_MODE_FAST_PWM_ICR_TOP:
                    REPLACE_BITS ( TCCR1A , ( 1 << WGM11 ) | ( 0 << WGM10 ) , BIT_MASK ( WGM11 ) | BIT_MASK ( WGM10 ) );
                    REPLACE_BITS ( TCCR1B , ( 1 << WGM13 ) | ( 1 << WGM12 ) , BIT_MASK ( WGM13 ) | BIT_MASK ( WGM12 ) );
        ...
        case TIMER_2:
            ...
            {
                case TIMER_MODE_NORMAL :
                    REPLACE_BITS ( TCCR2 , ( 0 << WGM21 ) | ( 0 << WGM20 ) , BIT_MASK ( WGM21 ) | BIT_MASK ( WGM20 ) );
                    break;
                case TIMER_MODE_CTC_OCR_TOP:
                    REPLACE_BITS ( TCCR2 , ( 1 << WGM21 ) | ( 0 << WGM20 ) , BIT_MASK ( WGM21 ) | BIT_MASK ( WGM20 ) );
                    break;
                case TIMER_MODE_FAST_PWM_MAX_TOP:
                    REPLACE_BITS ( TCCR2 , ( 1 << WGM21 ) | ( 1 << WGM20 ) , BIT_MASK ( WGM21 ) | BIT_MASK ( WGM20 ) );
                    break;
                case TIMER_MODE_PHASE_PWM_MAX_TOP:
                    REPLACE_BITS ( TCCR2 , ( 0 << WGM21 ) | ( 1 << WGM20 ) , BIT_MASK ( WGM21 ) | BIT_MASK ( WGM20 ) );
                    break;
                case TIMER_MODE_CTC_ICR_TOP:
                case TIMER_MODE_FAST_PWM_0xFF_TOP:
                case TIMER_MODE_FAST_PWM_0x1FF_TOP:
...
TIMER_STD_ERR_t TIMER_setCtcSetting ( TIMER_t timer , TIMER_CTC_SETTING_t settingToSet )
{
    ...
    switch ( timer )
    {
        case TIMER_0:
            ...
            {
                case CTC_NORMAL:
                    REPLACE_BITS ( TCCR0 , ( 0 << COM01 ) | ( 0 << COM00 ) , BIT_MASK ( COM01 ) | BIT_MASK ( COM00 ) );
                    break;
                case CTC_TOGGLE :
                    REPLACE_BITS ( TCCR0 , ( 0 << COM01 ) | ( 1 << COM00 ) , BIT_MASK ( COM01 ) | BIT_MASK ( COM00 ) );
                    break;
                case CTC_CLEAR:
                    REPLACE_BITS ( TCCR0 , ( 1 << COM01 ) | ( 0 << COM00 ) , BIT_MASK ( COM01 ) | BIT_MASK ( COM00 ) );
                    break;
                case CTC_SET:
                    REPLACE_BITS ( TCCR0 , ( 1 << COM01 ) | ( 1 << COM00 ) , BIT_MASK ( COM01 ) | BIT_MASK ( COM00 ) );
                    break;
                default:
        ...
        case TIMER_1A:
            ...
            {
                case CTC_NORMAL:
                    REPLACE_BITS ( TCCR1A , ( 0 << COM1A1 ) | ( 0 << COM1A0 ) , BIT_MASK ( COM1A1 ) | BIT_MASK ( COM1A0 ) );
                    break;
                case CTC_TOGGLE :
                    REPLACE_BITS ( TCCR1A , ( 0 << COM1A1 ) | ( 1 << COM1A0 ) , BIT_MASK ( COM1A1 ) | BIT_MASK ( COM1A0 ) );
                    break;
                case CTC_CLEAR:
                    REPLACE_BITS ( TCCR1A , ( 1 << COM1A1 ) | ( 0 << COM1A0 ) , BIT_MASK ( COM1A1 ) | BIT_MASK ( COM1A0 ) );
                    break;
                case CTC_SET:
                    REPLACE_BITS ( TCCR1A , ( 1 << COM1A1 ) | ( 1 << COM1A0 ) , BIT_MASK ( COM1A1 ) | BIT_MASK ( COM1A0 ) );
                    break;
                default:
                    opResult = TIMER_ERR_CTC;
            }
        ...
        case TIMER_1B:
            ...
            {
                case CTC_NORMAL:
                    REPLACE_BITS ( TCCR1B , ( 0 << COM1B1 ) | ( 0 << COM1B0 ) , BIT_MASK ( COM1B1 ) | BIT_MASK ( COM1B0 ) );
                    break;
                case CTC_TOGGLE :
                    REPLACE_BITS ( TCCR1B , ( 0 << COM1B1 ) | ( 1 << COM1B0 ) , BIT_MASK ( COM1B1 ) | BIT_MASK ( COM1B0 ) );
                    break;
                case CTC_CLEAR:
                    REPLACE_BITS ( TCCR1B , ( 1 << COM1B1 ) | ( 0 << COM1B0 ) , BIT_MASK ( COM1B1 ) | BIT_MASK ( COM1B0 ) );
                    break;
                case CTC_SET:
                    REPLACE_BITS ( TCCR1B , ( 1 << COM1B1 ) | ( 1 << COM1B0 ) , BIT_MASK ( COM1B1 ) | BIT_MASK ( COM1B0 ) );
                    break;
                default:
                    opResult = TIMER_ERR_CTC;
            }
        ...
        case TIMER_2:
            ...
            {
                case CTC_NORMAL:
                    REPLACE_BITS ( TCCR2 , ( 0 << COM21 ) | ( 0 << COM20 ) , BIT_MASK ( COM21 ) | BIT_MASK ( COM20 ) );
                    break;
                case CTC_TOGGLE :
                    REPLACE_BITS ( TCCR2 , ( 0 << COM21 ) | ( 1 << COM20 ) , BIT_MASK ( COM21 ) | BIT_MASK ( COM20 ) );
                    break;
                case CTC_CLEAR:
                    REPLACE_BITS ( TCCR2 , ( 1 << COM21 ) | ( 0 << COM20 ) , BIT_MASK ( COM21 ) | BIT_MASK ( COM20 ) );
                    break;
                case CTC_SET:
                    REPLACE_BITS ( TCCR2 , ( 1 << COM21 ) | ( 1 << COM20 ) , BIT_MASK ( COM21 ) | BIT_MASK ( COM20 ) );
                    break;
                default:
                    opResult = TIMER_ERR_CTC;
            }
