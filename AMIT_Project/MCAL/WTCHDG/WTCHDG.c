...
WTCHDG_STD_ERR_t WTCHDG_setPrescaller ( WTCHDG_PRESCALLER_t prescSetting )
{
    ...
    {
        REPLACE_BITS ( WDTCR , ( ( uint8_t ) prescSetting ) << WDP0 , BIT_MASK3 ( WDP2 , WDP1 , WDP0 ) );
    }
    else
    {
...
{
    return ( WTCHDG_PRESCALLER_t ) READ_BITS_AND_SHIFT ( WDTCR , BIT_MASK3 ( WDP2 , WDP1 , WDP0 ) , WDP0 );
}
